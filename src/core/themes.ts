...
export const THEMES:Record<ThemeId,Theme>={
  ...
  inferno:{id:'inferno',name:'焦灼地狱',subtitle:'THE BURNING INFERNO',floor:[0x2c1715,0x3a1d16,0x211113],stone:[0x703122],edge:0x120707,accent:0xee6331,props:[1,5,6]},
  ...
  palace:{id:'palace',name:'灰冠皇宫',subtitle:'THE ASHEN PALACE',floor:[0x302d32,0x3b353b,0x252329],stone:[0x806d69],edge:0x130f14,accent:0xd0a55f,props:[0,1,5]},
  catacomb:{id:'catacomb',name:'王室墓窟',subtitle:'THE ROYAL CATACOMBS',floor:[0x242524,0x2e2d2a,0x1c201f],stone:[0x5d594c],edge:0x0d0e0d,accent:0x9b8a63,props:[2,5,7]},
  ...
  desertTemple:{id:'desertTemple',name:'流沙神殿',subtitle:'THE BURIED TEMPLE',floor:[0x393128,0x44392c,0x2d2822],stone:[0x8c7657],edge:0x18130e,accent:0xe0b466,props:[0,1,5]},
